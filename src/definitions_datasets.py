...
PATH_SYDNEY = "src/data/SYDNEY/"
PATH_DATASETS_SYDNEY = PATH_SYDNEY + "datasets/"
...
def get_dataset_paths(dataset):
    if dataset == Datasets.RSICD.value:
        ...
        return PATH_SYDNEY, PATH_DATASETS_SYDNEY
...
def get_test_path(args, dataset_jsons):
    ...
    if args.eval_dataset_type == EvalDatasetType.VAL.value:
        ...
        decoding_args = args.file_name + "nw_v_" + args.decodying_type + "_" + str(args.n_beam) + "_" + str(
            args.min_len) + "_" + str(args.rep_window) + "_" + str(args.max_len) + '_coco'

    else:  # test set
        test_path = dataset_jsons + "test_coco_format.json"
        decoding_args = args.file_name + "nw_" + args.decodying_type + "_" + str(args.n_beam) + "_" + str(
            args.min_len) + "_" + str(args.rep_window) + "_" + str(args.max_len) + '_coco'
