...
for eval_file in [
    ...
    "ucmti_fine_attenscaleprod_3compgnr1statictend_effembcapglovesmoothl1_noaug.txt",
    "ucmti_fine_attenscaleprod_3compgnr1_ucmeffembcapglovesmoothl1_noaug.txt",
    "ucmti_fine_attenscaleprod_3comp_effembcapglovesmoothl1_noaug.txt",
    "ucmti_fine_attenscaleprod_discrete_ucmeffembcapglovesmoothl1_noaug.txt",
]:
