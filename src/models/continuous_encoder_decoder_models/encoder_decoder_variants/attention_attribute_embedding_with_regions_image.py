...
class FeaturesAndAttrAttention(nn.Module):
    ...
    def __init__(self, encoder_dim,  embed_dim, decoder_dim, attention_dim, embedding_attr):
        ...
        self.encoder_features_att = nn.Linear(encoder_dim, attention_dim)
        self.encoder_attr_att = nn.Linear(embed_dim, attention_dim)
        self.encoder_att = nn.Linear(attention_dim, attention_dim)
...
class ContinuousAttentionAttrEmbeddingWithRegionsImageModel(ContinuousAttentionImageModel):
