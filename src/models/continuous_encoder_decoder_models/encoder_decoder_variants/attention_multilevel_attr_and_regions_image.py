...
class FeaturesAndAttrAttention(nn.Module):
    ...
    def __init__(self, encoder_dim,  embed_dim, decoder_dim, attention_dim, embedding_attr):
        ...
        self.attr_att = nn.Linear(embed_dim, attention_dim)
        self.features_att = nn.Linear(encoder_dim, attention_dim)
        self.decoder_attr_att = nn.Linear(decoder_dim, attention_dim)
        self.decoder_features_att = nn.Linear(decoder_dim, attention_dim)
