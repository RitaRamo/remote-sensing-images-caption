...
class ContinuousDecoderWithMultilevelAttention(DecoderWithAttention):
    """
    Decoder.
    """
    ...
    def __init__(
        ...
        super(ContinuousDecoderWithMultilevelAttention, self).__init__(attention_dim, embedding_type,
...
class ContinuousAttentionMultilevelRegionMemoryModel(ContinuousAttentionModel):
    ...
    def _initialize_encoder_and_decoder(self):
        ...
        self.decoder = ContinuousDecoderWithMultilevelAttention(
    ...
    def inference_with_greedy(self, image, n_solutions=0):
        with torch.no_grad():  # no need to track history
            ...
            while True:
                ...
                predictions, h, c, z_context = self.decoder(input_word, encoder_output, h, c, all_cs, z_context)
                all_cs[0, i, :] = c
