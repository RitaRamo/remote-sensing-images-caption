...
class ContinuousScaleProductAttention3CompGradNormModel(ContinuousEncoderDecoderModel):
    ...
    # def inference_beam_without_refinement(
    #         self, image, n_solutions=3, min_len=2, repetition_window=0, max_len=50, alpha_consistency=0.02):
    ...
    def inference_beam_without_refinement(
            self, image, n_solutions=3, min_len=2, repetition_window=0, max_len=50, alpha_consistency=0.06):
