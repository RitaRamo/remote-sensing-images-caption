...
class ContinuousDecoderWithAttentionImageAndScheduleSampling(DecoderWithAttention):
    """
    Decoder.
    """
    ...
    def __init__(
        ...
        """
        super(ContinuousDecoderWithAttentionImageAndScheduleSampling, self).__init__(attention_dim,
...
class ContinuousAttentionImageWithScheduleSamplingModel(ContinuousEncoderDecoderModel):
    ...
    def _initialize_encoder_and_decoder(self):
        ...
        self.decoder = ContinuousDecoderWithAttentionImageAndScheduleSampling(
