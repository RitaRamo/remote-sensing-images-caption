...
class ContinuousAttentionWithScheduleSamplingModel(ContinuousEncoderDecoderModel):

    SAMPLING_INITIAL_RATE = 0.5
    ...
    def _predict(self, encoder_out, caps, caption_lengths):
        ...
        sampling_rate = self.SAMPLING_INITIAL_RATE * self.current_epoch
