...
from models.basic_encoder_decoder_models.encoder_decoder_variants.attention_tanh import Attention, DecoderWithAttention
...
class ContinuousDecoderWithAttention(DecoderWithAttention):
    ...
    def init_hidden_state(self, encoder_attr):
        ...
        h = self.init_h(self.image_embedding)  # (batch_size, decoder_dim) 512 units

        return h, h



class ContinuousAttentionTanhImgHCModel(ContinuousEncoderDecoderModel):
    ...
    def _initialize_encoder_and_decoder(self):
        ...
        self.encoder = ContinuousEncoder(self.args.image_model_type,
