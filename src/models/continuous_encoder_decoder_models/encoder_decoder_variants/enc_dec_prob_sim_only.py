...
class ContinuousDecoder(Decoder):
    ...
    def forward(self, word, encoder_out, decoder_hidden_state, decoder_cell_state):
        ...
        return attention_weighted_encoding, decoder_hidden_state, decoder_cell_state


class ContinuousEncoderDecoderProbSimOnlyModel(ContinuousEncoderDecoderModel):
    ...
    def _calculate_loss(self, predict_output, caps, caption_lengths):
        predictions_embeddings = predict_output["predictions"]
