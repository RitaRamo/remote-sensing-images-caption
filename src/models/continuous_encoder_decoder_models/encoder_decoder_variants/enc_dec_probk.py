...
class ContinuousEncoderDecoderProbSimKModel(ContinuousEncoderDecoderModel):
    ...
    def _calculate_loss(self, predict_output, caps, caption_lengths):
        ...
        targets = torch.cat(targets_probs, dim=0)
        predictions = F.log_softmax(predictions.data, -1)
