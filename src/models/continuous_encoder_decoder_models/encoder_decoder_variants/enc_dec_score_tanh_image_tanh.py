...
class ContinuousDecoderTanhImage(Decoder):
    ...
    def init_hidden_state(self, encoder_out):
        ...
        self.image_embedding = self.tanh(self.represent_image(mean_encoder_out))
    ...
    def forward(self, word, encoder_out, decoder_hidden_state, decoder_cell_state):
        ...
        scores = self.tanh(self.fc(self.dropout(decoder_hidden_state)))

        return scores, decoder_hidden_state, decoder_cell_state


class ContinuousEncoderDecoderScoreTanhImageTanhModel(ContinuousEncoderDecoderModel):
